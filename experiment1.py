...
#
ax.plot(x, y3, color='#2B9CD7', linestyle='-', linewidth=1.5, marker='*', markersize=9, label='LDMA1')
ax.plot(x, y4, color='#DB726B', linestyle='-', linewidth=1.5, marker='^', markersize=7, label='LDMA2')
